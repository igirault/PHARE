...
{
    return {
        {0u, mhdGhostWidth, mhdGhostWidth},
        {mhdGhostWidth - 1u, mhdGhostWidth + nCellsMHDY3D - 1u, mhdGhostWidth + nCellsMHDZ3D - 1u}};
}
...
{
    return {
        {mhdGhostWidth, 0u, mhdGhostWidth},
        {mhdGhostWidth + nCellsMHDX3D - 1u, mhdGhostWidth - 1u, mhdGhostWidth + nCellsMHDZ3D - 1u}};
}
...
{
    return {
        {mhdGhostWidth, mhdGhostWidth, 0u},
        {mhdGhostWidth + nCellsMHDX3D - 1u, mhdGhostWidth + nCellsMHDY3D - 1u, mhdGhostWidth - 1u}};
}
