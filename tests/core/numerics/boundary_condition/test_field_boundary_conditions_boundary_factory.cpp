...
{
    auto boundary
        = Factory::create(BoundaryLocation::XLower, dictFor(type), mhdScalars, mhdVectors, gamma);
...
{
    checkDispatch("open",
                  {{{Scalar::rho, FBC::Neumann}, {Scalar::Etot, FBC::TotalEnergyFromPressure}},
                   {{Vector::B, FBC::DivergenceFreeTransverseNeumann},
                    {Vector::E, FBC::None},
...
TEST(BoundaryFactory, SuperMagnetofastInflow)
{
    checkDispatch("super-magnetofast-inflow",
                  {{{Scalar::rho, FBC::Dirichlet}, {Scalar::Etot, FBC::TotalEnergyFromPressure}},
